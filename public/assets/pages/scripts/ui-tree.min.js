var UITree=function(){var e=function(){$("#tree_1").jstree({core:{themes:{responsive:!1}},types:{"default":{icon:"fa fa-folder icon-state-warning icon-lg"},file:{icon:"fa fa-file icon-state-warning icon-lg"}},plugins:["types"]}),$("#tree_1").on("select_node.jstree",function(e,t){var n=$("#"+t.selected).find("a");return"#"!=n.attr("href")&&"javascript:;"!=n.attr("href")&&""!=n.attr("href")?("_blank"==n.attr("target")&&(n.attr("href").target="_blank"),document.location.href=n.attr("href"),!1):void 0})}
,t=function(){$("#tree_2").jstree({plugins:["wholerow","checkbox","types"]
        ,core:{themes:{responsive:!1},data:[{text:"Same but with checkboxes"
