...
!function (t) {
    ...
    n(2), window.kamaDatepicker = function (t, e) {
        ...
        var n, o, a, r, i, d, s, l, c, p = e || {}, u = !1, f = !1,
            g = ["٠", "١", "٢", "٣", "۴", "۵", "۶", "٧", "٨", "٩", "١٠", "١١", "١٢", "١٣", "١۴", "١۵", "١۶", "١٧", "١٨", "١٩", "٢٠", "٢١", "٢٢", "٢٣", "٢۴", "٢۵", "٢۶", "٢٧", "٢٨", "٢٩", "٣٠", "٣١", "٣٢"];
        p.placeholder = void 0 !== p.placeholder ? p.placeholder : "", p.twodigit = void 0 === p.twodigit || p.twodigit, p.closeAfterSelect = void 0 === p.closeAfterSelect || p.closeAfterSelect, p.nextButtonIcon = void 0 !== p.nextButtonIcon && p.nextButtonIcon, p.previousButtonIcon = void 0 !== p.previousButtonIcon && p.previousButtonIcon, p.buttonsColor = void 0 !== p.buttonsColor && p.buttonsColor, p.forceFarsiDigits = void 0 !== p.forceFarsiDigits && p.forceFarsiDigits, p.markToday = void 0 !== p.markToday && p.markToday, p.markHolidays = void 0 !== p.markHolidays && p.markHolidays, p.highlightSelectedDay = void 0 !== p.highlightSelectedDay && p.highlightSelectedDay, p.sync = void 0 !== p.sync && p.sync, p.gotoToday = void 0 !== p.gotoToday && p.gotoToday, p.pastYearsCount = isNaN(p.pastYearsCount) ? 95 : p.pastYearsCount, p.futureYearsCount = isNaN(p.futureYearsCount) ? 6 : p.futureYearsCount;
        var v = $("#" + t);
        ...
        function D() {
            var e, n, o, a = document.querySelector("#bd-main-".concat(t)), r = document.querySelector("#".concat(t));
            if (r.offsetHeight, a.offsetHeight, "top" === p.position) a.style.top = "".concat(-1 * a.offsetHeight, "px"); else if ("auto" === p.position) {
                var i;
            ...
            var s, l,
                c = (s = a.getBoundingClientRect(), (l = {}).top = s.top < 0, l.left = s.left < 0, l.bottom = s.bottom > (window.innerHeight || document.documentElement.clientHeight), l.right = s.right > (window.innerWidth || document.documentElement.clientWidth), l.any = l.top || l.left || l.bottom || l.right, l.all = l.top && l.left && l.bottom && l.right, l);

            function u(t) {
                var e = t.getBoundingClientRect(), n = e.top, o = e.left;
                return {x: o, y: n}
            }
        ...
        v.on("focus", function () {
            b.removeClass("bd-hide"), p.sync && !1 === f && (q(), f = !0), D()
        }).on("blur", function () {
            ...
            n = parseInt(this.value), s = E(n, o), d = M(n, o), R(s, d), D()
        });
        var H = [31, 28, 31, 30, 31, 30, 31, 31, 30, 31, 30, 31], B = [31, 31, 31, 31, 31, 31, 30, 30, 30, 30, 30, 29];
        ...
        l = new Date, c = function (t, e, n) {
            ...
            var s = (i += r) - 79, l = parseInt(s / 12053);
            s %= 12053;
        ...
        var R = function (e, d) {
            w.empty();
            for (var s = 1, l = 1; s <= e;) {
                w.append($("<tr>", {class: "tr-" + l}));
                for (var c = 0; c < 7; c++) {
                    if (1 == s) for (var u = 0; u < d;) $("#bd-table-days-" + t + " .tr-1").append($("<td>", {class: "bd-empty-cell"})), u++, c++;
                    if (c < 7 && s <= e) {
                        ...
                        if (p.markToday && s == i && r == o && a == n) {
                            ...
                            f = f.slice(0, y) + " bd-today " + f.slice(y)
                        }
        ...
        v.parent().on("click", "button.day", function () {
            ...
            p.twodigit && (t = A(t)), v.val(t), v.trigger("change"), p.closeAfterSelect && (u = !1, v.trigger("blur")), p.highlightSelectedDay && (b.find(".bd-selected-day").removeClass("bd-selected-day"), $(this).addClass("bd-selected-day"))
        }), m.on("click", function () {
